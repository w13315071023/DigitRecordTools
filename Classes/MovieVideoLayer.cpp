...
void MovieVideoLayer::ShowVideo()
{
	if (m_VideoList.empty())
	{
		m_IsPlayOver = true;
...
void MovieVideoLayer::ReSetVideo()
{
	m_VideoIndex = 0;
	ShowVideo();
}
...
void MovieVideoLayer::PackagingVideo(const char* pFilePath)
{
	int ret = 0;
	int got_packet = 0;
	const char* outFilePath = pFilePath;
